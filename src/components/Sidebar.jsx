    ...
    <>
      <div className="p-6 border-b border-gray-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-[#1a1f36]">Fitness House</h1>
            ...
            <div className="p-4 border-b border-gray-100 flex justify-between items-center">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#2d60ff] to-[#343c6a] flex items-center justify-center">
                  <span className="text-white text-sm">FH</span>
                </div>
                <span className="font-bold text-[#1a1f36]">Fitness House</span>
              </div>
